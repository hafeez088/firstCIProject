...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    ...
    ?>
      <input class="form-control mr-sm-2" name="searchdata" type="text" placeholder="keywords">
      <button class="btn btn-secondary my-2 my-sm-0" type="submit" name="submit">Search</button>
   <?= form_close(); ?>
      <a href="<?php echo base_url('login'); ?>" class="btn btn-danger my-2 my-sm-0" type="submit">Login</a>
       <?= form_error('searchdata',"<p class='navbar-text text-danger'>",'</p>'); ?>
  </div>
</nav>